...
<body>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12">
                <h4 style="text-align:center;">{{ $mail->nama }}</h4>
            </div>
        </div>
    </div>

                <form action="/email" method="post" class="d-inline md">
                    @csrf
                ...
                <div align = "center">
                    <button class="button" onclick="return confirm('Are you sure ?')">Approved</button>
